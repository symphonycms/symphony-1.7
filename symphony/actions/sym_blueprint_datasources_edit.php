<?php
	...
	if(array_key_exists("save", $_POST['action']) || array_key_exists("done", $_POST['action'])) {	
		...
		if(is_array($errors)){			
            ...
            $file = DATASOURCES . "/data." . $handle . ".php";
          	$oldfile = DATASOURCES . "/data." . $_REQUEST['file'] . ".php";
          	
			##Duplicate
			if($file != $oldfile && @is_file($file)){
			...
			##Write Successful, add record to the database
				...
				if($file != $oldfile) @unlink($oldfile);
				...
				$CampfireManager->notifyMembers('Edit', CURRENTPAGE, array('file' => $file, 'defines' => $defines, 'var' => $var));				
	...
	if(@array_key_exists("delete", $_POST['action'])) {
		...
		$CampfireManager->notifyMembers('Delete', CURRENTPAGE, array("file" => DATASOURCES . "/data." . $_REQUEST['file'] . ".php"));

    	@unlink(DATASOURCES . "/data." . $_REQUEST['file'] . ".php");	
