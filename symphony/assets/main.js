/*
	Symphony Admin JavaScript

	Documentation for the Symphony admin JavaScript, intended for Campfire
	developers who wish to include JavaScript with their Campfire services
	can be found at:

	http://overture21.com/wiki/campfire-api/javascript
*/
